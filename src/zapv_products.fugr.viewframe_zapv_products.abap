...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZAPV_PRODUCTS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZAPV_PRODUCTS_EXTRACT
TOTAL = ZAPV_PRODUCTS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZAPV_PRODUCTS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZAPV_PRODUCTS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAPV_PRODUCTS_EXTRACT
TOTAL = ZAPV_PRODUCTS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZAPV_PRODUCTS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZAPV_PRODUCTS'
...
TOTAL = ZAPV_PRODUCTS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZAPV_PRODUCTS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZAPV_PRODUCTS-UPD_FLAG NE SPACE.
