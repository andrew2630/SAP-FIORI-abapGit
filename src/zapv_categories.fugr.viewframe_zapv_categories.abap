*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZAPV_CATEGORIES
*   generation date: 11.02.2022 at 19:06:44
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZAPV_CATEGORIES     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZAPV_CATEGORIES'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZAPV_CATEGORIES_EXTRACT
TOTAL = ZAPV_CATEGORIES_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZAPV_CATEGORIES'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZAPV_CATEGORIES-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAPV_CATEGORIES_EXTRACT
TOTAL = ZAPV_CATEGORIES_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZAPV_CATEGORIES-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZAPV_CATEGORIES'
...
TOTAL = ZAPV_CATEGORIES_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZAPV_CATEGORIES-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZAPV_CATEGORIES-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZAPV_CATEGORIES'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZAPV_CATEGORIES-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAPV_CATEGORIES_EXTRACT
TOTAL = ZAPV_CATEGORIES_TOTAL
