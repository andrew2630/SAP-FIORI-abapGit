class ZCL_ZAP_UI5_TRAINIG_MPC definition
  public
...
public section.
  ...
  types:
     TS_CATEGORY type ZAP_ODATA_CATEGORY .
  types:
TT_CATEGORY type standard table of TS_CATEGORY .
  ...
  types:
     TS_PRODUCTS type ZAP_ODATA_PRODUCT .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZAP_UI5_TRAINIG_MPC=======CP' ##NO_TEXT.
...
CLASS ZCL_ZAP_UI5_TRAINIG_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZAP_UI5_TRAINIG_SRV' ).
...
lo_property = lo_entity_type->create_property( iv_property_name = 'CategoryID' iv_abap_fieldname = 'CATEGORY_ID' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZAP_ODATA_CATEGORY'
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ProductName' iv_abap_fieldname = 'PRODUCT_NAME' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DateAdded' iv_abap_fieldname = 'DATE_ADDED' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZAP_ODATA_PRODUCT'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220218151521'.                  "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'ProductName'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Products'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'DateAdded'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Products'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
