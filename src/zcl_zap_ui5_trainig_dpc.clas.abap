class ZCL_ZAP_UI5_TRAINIG_DPC definition
  public
...
protected section.
  ...
  methods CATEGORYSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZAP_UI5_TRAINIG_MPC=>TS_CATEGORY
    raising
  ...
  methods CATEGORYSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZAP_UI5_TRAINIG_MPC=>TT_CATEGORY
...
CLASS ZCL_ZAP_UI5_TRAINIG_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 04.03.2022 16:32:50 in client 010
*&*
...
*-------------------------------------------------------------
 ...
 DATA lr_category_id LIKE RANGE OF ls_converted_keys-category_id.
 DATA ls_category_id LIKE LINE OF lr_category_id.
 DATA lo_dp_facade TYPE REF TO /iwbep/if_mgw_dp_facade.
 DATA ls_gw_results LIKE LINE OF et_entityset.
     ...
     CASE ls_filter-property.
       WHEN 'CATEGORY_ID'.
         lo_filter->convert_select_option(
           ...
           IMPORTING
             et_select_option = lr_category_id ).

         READ TABLE lr_category_id INTO ls_category_id INDEX 1.
         IF sy-subrc = 0.
           category_id = ls_category_id-low.
         ENDIF.
       WHEN OTHERS.
         " Log message in the application log
         me->/iwbep/if_sb_dpc_comm_services~log_message(
...
*-------------------------------------------------------------
 lv_rfc_name = 'Z_AP_GET_CATEGORIES'.
