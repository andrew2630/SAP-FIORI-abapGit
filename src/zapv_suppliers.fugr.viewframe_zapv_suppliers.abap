*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZAPV_SUPPLIERS
*   generation date: 11.02.2022 at 19:08:51
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZAPV_SUPPLIERS      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZAPV_SUPPLIERS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZAPV_SUPPLIERS_EXTRACT
TOTAL = ZAPV_SUPPLIERS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZAPV_SUPPLIERS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZAPV_SUPPLIERS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAPV_SUPPLIERS_EXTRACT
TOTAL = ZAPV_SUPPLIERS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZAPV_SUPPLIERS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZAPV_SUPPLIERS'
...
TOTAL = ZAPV_SUPPLIERS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZAPV_SUPPLIERS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZAPV_SUPPLIERS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZAPV_SUPPLIERS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZAPV_SUPPLIERS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAPV_SUPPLIERS_EXTRACT
TOTAL = ZAPV_SUPPLIERS_TOTAL
